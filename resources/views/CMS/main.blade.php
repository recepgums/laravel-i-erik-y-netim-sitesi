                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <li>
                                <a href="{{route('Front.home.index')}}"><i class="fa fa-home"></i>Home</a>
                            </li>
                            <li><a><i class="fa fa-edit"></i> Menu <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('CMS.menu.list')}}">Menu List</a></li>
                                    <li><a>Menu Add<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li class="sub_menu">
                                                <a href="{{route('CMS.menu.create')}}">Menu</a>
                                            </li>
                                            <li>
                                                <a href="{{route('CMS.menu.createsub')}}">Submenu</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
